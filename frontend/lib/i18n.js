...
export const translations = {
  ru: {
    ...
    redistributedOnlyNotice: "Товар \"{item}\" удалён из \"{wishlist}\". {moved} {currency} перенесено на другие подарки по приоритету.",
    refundedOnlyNotice: "Товар \"{item}\" удалён из \"{wishlist}\". {refunded} {currency} возвращено в твой баланс.",
    redistributedAndRefundedNotice: "Товар \"{item}\" удалён из \"{wishlist}\". {moved} {currency} перенесено, {refunded} {currency} возвращено.",
    ...
    wishlistEmptyAuthorPending: "Автор пока что не добавил подарки.",
    ...
    liveItemRemoved: "Товар удалён",
    liveItemPriorityChanged: "Изменён приоритет товара",
    ...
    recipientCannotContribute: "Получатель этого вишлиста не может вносить вклад",
    minContribution: "Минимальный вклад:",
    contributionAccepted: "Учтено:",
    contributionRefunded: "Возврат:",
    contributionTransferred: "Перенесено по приоритету:",
    ...
    loginToViewNotifications: "Войди, чтобы увидеть уведомления.",
    markAllRead: "Прочитать все",
    notificationsInApp: "In-app",
    notificationsPush: "Push",
    notificationsWishlist: "Новый вишлист/товар",
    notificationsReservations: "Резервы",
  ...
  en: {
    ...
    redistributedOnlyNotice: "Item \"{item}\" was removed from \"{wishlist}\". {moved} {currency} moved to other gifts by priority.",
    refundedOnlyNotice: "Item \"{item}\" was removed from \"{wishlist}\". {refunded} {currency} returned to your balance.",
    redistributedAndRefundedNotice: "Item \"{item}\" was removed from \"{wishlist}\". {moved} {currency} moved, {refunded} {currency} returned.",
    ...
    wishlistEmptyAuthorPending: "The author has not added gifts yet.",
    ...
    liveItemRemoved: "Item was removed",
    liveItemPriorityChanged: "Item priority changed",
    ...
    recipientCannotContribute: "Recipient of this wishlist cannot contribute",
    minContribution: "Minimum contribution:",
    contributionAccepted: "Accepted:",
    contributionRefunded: "Refund:",
    contributionTransferred: "Moved by priority:",
    ...
    notificationsInApp: "In-app",
    notificationsPush: "Push",
    notificationsWishlist: "New wishlist/item",
    notificationsReservations: "Reservations",
